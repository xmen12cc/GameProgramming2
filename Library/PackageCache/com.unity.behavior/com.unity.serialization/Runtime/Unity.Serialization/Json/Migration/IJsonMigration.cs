namespace Unity.Behavior.Serialization.Json
{
    ...
    /// </summary>
    internal interface IJsonMigration
    {
    ...
    internal interface IJsonMigration<TValue> : IJsonMigration
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TValue">The type this interface defines migration for.</typeparam>
    internal interface IContravariantJsonMigration<in TValue> : IJsonMigration
    {
        /// <summary>
        /// The current serialized version for the type.
        /// </summary>
